...
from hashlib import md5   # for gravatar hash
...
# it is an association, so let's not set it as a model
...
class User(UserMixin, db.Model):  # Important to inherit from UserMixin
    ...
    posts = db.relationship('Post', backref='author', lazy='dynamic') # Important to add this method
